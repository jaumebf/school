    ...
    function modificarForm(Request $request) {
        ...
        if ($exist) {          
            ...
            for ($i = 0; $i < $numAssignatures; $i++) {
                ...
                $assignatures->treball_1 = ($request->input('treball1_' . $assignatura_id)) ? $assignatures->treball_1 = $request->input('treball1_' . $assignatura_id) : $assignatures->treball_1 = 0;
                $assignatures->treball_2 = ($request->input('treball2_' . $assignatura_id)) ? $assignatures->treball_2 = $request->input('treball2_' . $assignatura_id) : $assignatures->treball_2 = 0;
                $assignatures->treball_3 = ($request->input('treball3_' . $assignatura_id)) ? $assignatures->treball_3 = $request->input('treball3_' . $assignatura_id) : $assignatures->treball_3 = 0;
                $assignatures->deures_1 = ($request->input('deures1_' . $assignatura_id)) ? $assignatures->deures_1 = $request->input('deures1_' . $assignatura_id) : $assignatures->deures_1 = 0;
                $assignatures->deures_2 =($request->input('deures2_' . $assignatura_id)) ? $assignatures->deures_2 = $request->input('deures2_' . $assignatura_id) : $assignatures->deures_2 = 0;
                $assignatures->deures_3 = ($request->input('deures3_' . $assignatura_id)) ? $assignatures->deures_3 = $request->input('deures3_' . $assignatura_id) : $assignatures->deures_3 = 0;
                $assignatures->adaptats = 0;
                $assignatures->qualificacio_1 = ($request->input('qualificacio1_' . $assignatura_id)) ? $assignatures->qualificacio_1 = $request->input('qualificacio1_' . $assignatura_id) : $assignatures->qualificacio_1 = 5;
                $assignatures->qualificacio_2 = ($request->input('qualificacio2_' . $assignatura_id)) ? $assignatures->qualificacio_2 = $request->input('qualificacio2_' . $assignatura_id) : $assignatures->qualificacio_2 = 5;
                $assignatures->qualificacio_3 = ($request->input('qualificacio3_' . $assignatura_id)) ? $assignatures->qualificacio_3 = $request->input('qualificacio3_' . $assignatura_id) : $assignatures->qualificacio_3 = 5;
